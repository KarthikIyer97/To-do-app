...
function App() {
  ...
  return (
    <>
    <Navbar/>
    <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-50 min-h-[80vh] md:w-[40%]">
    <h1 className='font-bold text-center text-2xl'>iTask - Manage your todos at one place</h1>
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <button onClick={handleAdd} disabled={todo.length<=3} className='bg-violet-800 disabled:bg-violet-800 mx-2 rounded-full hover:bg-violet-950 p-4 py-2 text-sm font-bold text-white'>Save</button>
          </div>
        </div>

        <input className='my-2' type="checkbox" onChange={toggleFinished} checked={showFinished} /><label className='mx-2' htmlFor="show">Show Finished</label>
